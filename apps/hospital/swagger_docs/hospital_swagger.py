...
# from apps.users.models import UserHospital, UserRole
...
# def get_user_and_role_schema():
#     return swagger_auto_schema(
#         manual_parameters=[
#             openapi.Parameter(
#                 'hospital_id',
#                 openapi.IN_PATH,  # क्योंकि आपने function में hospital_id as path param लिया है
#                 description="ID of the hospital to fetch users and their roles",
#                 type=openapi.TYPE_INTEGER,
#                 required=True
#             )
#         ],
#         operation_description="Fetch all users of a hospital with their assigned roles",
#         responses={
#             200: openapi.Response(
...
#                 }
#             ),
#             404: openapi.Response(description="Hospital not found or no users found"),
#             500: openapi.Response(description="Internal server error"),
#         }
#     )
